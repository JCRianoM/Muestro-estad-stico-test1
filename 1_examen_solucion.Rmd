...
Para realizar los análisis de manera más eficiente se definieron 10 funciones para el muestreo aleatorio simple como para el muestro sistemático. que se pueden ver en los archivos en el siguiente repositorio propio de Github: 
